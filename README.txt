...
To troubleshoot this, I had to do [tokenID - 1000] to get the correct index number. It's also possible the token type was not being assigned properly in scanner.c when assigning
the state to token.type.
